Run the server exe first then run the client exe. 

Controlled are wasd, mouse to shoot, the bullet goes in the trajectory of the player and mouse.  

To control a player individually it needs to be separate machines.
